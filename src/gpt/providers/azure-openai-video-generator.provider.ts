...
import { AzureVideoEndpoints } from '../use-cases/gpt-model/gpt-endpoints';
import { GptModels } from '../use-cases/gpt-model/gpt-models';
import { AzureVideoGenerationJob } from '../use-cases/shared/azure-video-types';
import * as fs from 'fs';
import * as path from 'path';

@Injectable()
export class AzureOpenAiVideoGenerator implements VideoGenerator {
    private readonly logger = new Logger(AzureOpenAiVideoGenerator.name);
